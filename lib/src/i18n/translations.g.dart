...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	// Translations
	late final _TranslationsValidatorsEn validators = _TranslationsValidatorsEn._(_root);
}

// Path: validators
class _TranslationsValidatorsEn {
...
// Path: validators
class _TranslationsValidatorsFr implements _TranslationsValidatorsEn {
